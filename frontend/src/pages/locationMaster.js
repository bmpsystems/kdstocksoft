    ...
    return (
        <div style={{ padding: '20px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
                ...
                <h2 style={{ margin: 0 }}>Location Master</h2>
                                        ...
                                        <div
                                            onClick={async () => {
                                                ...
                                                const confirmMessage = isActive
                                                    ? 'Do you want to deactivate this location?'
                                                    : 'Do you want to activate this location?';
                                                ...
                                                if (window.confirm(confirmMessage)) {
                                                    ...
                                                    if (newStatus) {
                                                        ...
                                                        Swal.fire({
                                                            icon: 'success',
                                                            title: 'Location Data Inactivated',
                                                            confirmButtonText: 'OK',
                                                            confirmButtonColor: '#3085d6'
                                                        });
                                                    }
                ...
                <div style={styles.overlay}>
                    <div style={styles.modal}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                            <h3 style={{ margin: 0 }}>Edit Location</h3>
                            <button
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginBottom: '32px' }}>
                            <div style={{ width: '100%' }}>
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        setEditProduct((prev) => ({ ...prev, location: e.target.value }))
                                    }
                                    style={{
                                        ...styles.input,
                                        width: '100%',
