...
const RegionMaster = () => {
    ...
    const [newProduct, setNewProduct] = useState({ region: '', Created_By: '', Modified_By: '' });
    ...
    const handleAddClick = () => {
        setNewProduct({  region: '', Created_By: '', Modified_By: ''  }); // Reset values before showing modal
        setShowModal(true);
    };

    const handleClose = () => {
        setNewProduct({  region: '', Created_By: '', Modified_By: ''  }); // Reset values
        setShowModal(false);
    };
    ...
    const handleSubmit = () => {
        ...
        axios.post(`${API_URL}/create`, productToSend)
            .then(() => {
                ...
                setNewProduct({ region: '', Created_By: '', Modified_By: '' });
                setShowModal(false);
                Swal.fire({
                    icon: 'success',
    ...
    const handleEditSubmit = () => {
        ...
        if (editProduct.region == "") {
            alert('Please enter Region');
            return
        }

        const productToUpdate = {
            Region: editProduct.region,
    ...
    return (
        <div style={{ padding: '20px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
                ...
                <h2 style={{ margin: 0 }}>Region Master</h2>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <thead>
                    <tr style={{ backgroundColor: '#f4f4f4' }}>
                        ...
                        <th style={{ ...styles.th, width: '20%' }}>Region</th>
                                ...
                                <tr key={product.Id}>
                                    ...
                                    <td style={styles.td} align="center">
                                        <button
                                            ...
                                            aria-label={`Edit ${product.Region}`}
                                        >
                                            📝
                                        </button>
                                    </td>
                                        ...
                                        <div
                                            onClick={async () => {
                                                ...
                                                const confirmMessage = isActive
                                                    ? 'Do you want to deactivate this region?'
                ...
                <div style={styles.overlay}>
                    <div style={styles.modal}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                            <h3 style={{ margin: 0 }}>Edit Region</h3>
                            <button
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginBottom: '32px' }}>
                            <div style={{ width: '100%' }}>
                                <label htmlFor="edit-region" style={{ display: 'block', marginBottom: '6px', }}>
                                    Region
                                </label>
                                <input
                                    id="edit-region"
                                    ...
                                    onChange={(e) =>
                                        setEditProduct((prev) => ({ ...prev, region: e.target.value }))
                                    }
                                    style={{
                                        ...styles.input,
                                        width: '100%',
            ...
            {showModal && (
                <div style={styles.overlay}>
                    <div style={styles.modal}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                            <h3 style={{ margin: 0 }}>Add Region</h3>
                            <button
                                onClick={handleClose}
                                style={{
                                    background: 'none',
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginBottom: '32px' }}>
                            <div style={{ width: '100%' }}>
                                <label htmlFor="add-region" style={{ display: 'block', marginBottom: '6px' }}>
                                    Region
                                </label>
                                <input
                                    id="add-region"
