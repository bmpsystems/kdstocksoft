...
const DefectiveItems = () => {
        ...
        axios
            ...
            .then((res) => {
                ...
                if (res.data.length > 0) {
                    setSelectedMakeId(res.data.Id.toString()); // Set default makeId
                }
            })
    ...
    // Fetch defective items and godown name when make/category/warehouse changes
    useEffect(() => {
        const fetchStock = async () => {
            ...
            try {
                ...
                // Calculate total amount (sum of Cost_Price * Quantity for all items)
                ...
                console.error('❌ Error fetching Defective Items List:', error.message);
                setGodownName('');
                setStockData([]);
                setTotalAmount(0);
            }
    ...
    const isLowStock = (stock) => {
        return Number(stock.Quantity) < 50;
    };
    ...
    return (
        <div style={{ padding: '20px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
                <h2 style={{ margin: 0 }}>
                    {selectedMakeName} Defective Items
                        ...
                        [...sortedFiltered]
                            ...
                            .map((stock) => (
                                ...
                                >
                                    ...
                                    <td style={{ ...styles.td, width: columnWidths[4] }}>{stock.Quantity + " " + stock.Unit}</td>
                                    <td style={{ ...styles.td, width: columnWidths[5] }}>
                                        ₹ {(stock.Cost_Price * stock.Quantity).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                                    </td>
