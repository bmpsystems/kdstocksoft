...
const UnitMaster = () => {
    ...
    useEffect(() => {
        ...
        const results = products.filter((product) =>
            product.Unit?.toLowerCase().includes(lowerTerm)
        );
        setFiltered(results);
        setCurrentPage(1);
    }, [searchTerm, products]);
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <thead>
                    <tr style={{ backgroundColor: '#f4f4f4' }}>
                        ...
                        <th style={{ ...styles.th, width: '20%' }}>Unit</th>
                ...
                <div style={styles.overlay}>
                    <div style={styles.modal}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginBottom: '32px' }}>
                            <div style={{ width: '100%' }}>
                                <label htmlFor="edit-unit" style={{ display: 'block', marginBottom: '6px', }}>
                                Unit
                                </label>
                                <input
                                    id="edit-unit"
            ...
            {showModal && (
                <div style={styles.overlay}>
                    <div style={styles.modal}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginBottom: '32px' }}>
                            <div style={{ width: '100%' }}>
                                <label htmlFor="add-unit" style={{ display: 'block', marginBottom: '6px' }}>
                                Unit
                                </label>
                                <input
                                    id="add-unit"
