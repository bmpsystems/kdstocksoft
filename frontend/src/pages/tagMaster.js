...
const TagMaster = () => {
    ...
    useEffect(() => {
        ...
        const results = products.filter((product) =>
            product.Tag?.toLowerCase().includes(lowerTerm)
        );
        setFiltered(results);
        setCurrentPage(1);
    }, [searchTerm, products]);
    ...
    return (
        <div style={{ padding: '20px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
                ...
                <h2 style={{ margin: 0 }}>Tag Master</h2>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <thead>
                    <tr style={{ backgroundColor: '#f4f4f4' }}>
                        ...
                        <th style={{ ...styles.th, width: '20%' }}>Tag</th>
                                        ...
                                        <div
                                            onClick={async () => {
                                                ...
                                                const confirmMessage = isActive
                                                    ...
                                                    : 'Do you want to activate this Tag?';
                ...
                <div style={styles.overlay}>
                    <div style={styles.modal}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginBottom: '32px' }}>
                            <div style={{ width: '100%' }}>
                                <label htmlFor="edit-tag" style={{ display: 'block', marginBottom: '6px', }}>
                                    Tag
                                </label>
                                <input
                                    id="edit-tag"
                                    ...
                                    onChange={(e) =>
                                        setEditProduct((prev) => ({ ...prev, tag: e.target.value }))
                                    }
                                    style={{
                                        ...styles.input,
                                        width: '100%',
            ...
            {showModal && (
                <div style={styles.overlay}>
                    <div style={styles.modal}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginBottom: '32px' }}>
                            <div style={{ width: '100%' }}>
                                <label htmlFor="add-tag" style={{ display: 'block', marginBottom: '6px' }}>
                                    Tag
                                </label>
                                <input
                                    id="add-tag"
