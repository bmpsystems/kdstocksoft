...
const TypeMaster = () => {
    ...
    const handleSubmit = () => {
        ...
        axios.post(`${API_URL}/create`, productToSend)
            ...
            .catch((err) => {
                console.error("❌ Error adding Type:", err.response?.data || err.message);
    ...
    return (
        <div style={{ padding: '20px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
                ...
                <h2 style={{ margin: 0 }}>Type Master</h2>
                                        ...
                                        <div
                                            onClick={async () => {
                                                ...
                                                const confirmMessage = isActive
                                                    ? 'Do you want to deactivate this Type?'
                                                    : 'Do you want to activate this Type?';
                ...
                <div style={styles.overlay}>
                    <div style={styles.modal}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginBottom: '32px' }}>
                            <div style={{ width: '100%' }}>
                                <label htmlFor="edit-type" style={{ display: 'block', marginBottom: '6px', }}>
                                    Type
                                </label>
                                <input
                                    id="edit-type"
                                    ...
                                    onChange={(e) =>
                                        setEditProduct((prev) => ({ ...prev, type: e.target.value }))
                                    }
                                    style={{
                                        ...styles.input,
                                        width: '100%',
            ...
            {showModal && (
                <div style={styles.overlay}>
                    <div style={styles.modal}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginBottom: '32px' }}>
                            <div style={{ width: '100%' }}>
                                <label htmlFor="add-type" style={{ display: 'block', marginBottom: '6px' }}>
                                    Type
                                </label>
                                <input
                                    id="add-type"
