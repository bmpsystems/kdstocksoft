...
const DesignationMaster = () => {
    ...
    const API_URL = 'https://kdstocksoft.onrender.com/designation';
    ...
    const toggleActive = (id) => {
        axios
            ...
            .catch((error) => {
                ...
                alert('Failed to toggle Designation status.');
            });
    };
    ...
    return (
        <div style={{ padding: '20px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
                ...
                <h2 style={{ margin: 0 }}>Designation Master</h2>
                                ...
                                <tr key={product.Id}>
                                    ...
                                    <td style={styles.td} align="center">
                                        <button
                                            ...
                                            aria-label={`Edit ${product.Designation}`}
                                        >
                                            📝
                                        </button>
                                    </td>
                                        ...
                                        <div
                                            onClick={async () => {
                                                ...
                                                const confirmMessage = isActive
                                                    ? 'Do you want to deactivate this Designation?'
                                                ...
                                                if (window.confirm(confirmMessage)) {
                                                    ...
                                                    if (newStatus) {
                                                        Swal.fire({
                                                            icon: 'success',
                                                            title: 'Designation Data Activated',
                                                            confirmButtonText: 'OK',
                                                            confirmButtonColor: '#3085d6'
                                                        });
                                                    } else {
                                                        Swal.fire({
                                                            icon: 'success',
                                                            title: 'Designation Data Inactivated',
                                                            confirmButtonText: 'OK',
                                                            confirmButtonColor: '#3085d6'
                                                        });
                                                    }
                ...
                <div style={styles.overlay}>
                    <div style={styles.modal}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginBottom: '32px' }}>
                            <div style={{ width: '100%' }}>
                                <label htmlFor="edit-designation" style={{ display: 'block', marginBottom: '6px', }}>
                                    Designation
                                </label>
                                <input
                                    id="edit-designation"
                                    ...
                                    onChange={(e) =>
                                        setEditProduct((prev) => ({ ...prev, designation: e.target.value }))
                                    }
                                    style={{
                                        ...styles.input,
                                        width: '100%',
            ...
            {showModal && (
                <div style={styles.overlay}>
                    <div style={styles.modal}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                            <h3 style={{ margin: 0 }}>Add Designation</h3>
                            <button
                                onClick={handleClose}
                                style={{
                                    background: 'none',
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginBottom: '32px' }}>
                            <div style={{ width: '100%' }}>
                                <label htmlFor="add-designation" style={{ display: 'block', marginBottom: '6px' }}>
                                    Designation
                                </label>
                                <input
                                    id="add-designation"
